...
function calcularNotas(valor) {
    ...
    for (const nota of notasDisponiveis) {
        ...
        if (quantidade > 0) {
            resultado[`GC$ ${nota},00`] = quantidade;
...
const valorDesejado = parseInt(prompt("Informe o valor desejado em GrowCoins: "));
const resultado = calcularNotas(valorDesejado);

console.log("Notas necessárias para o valor desejado:");
